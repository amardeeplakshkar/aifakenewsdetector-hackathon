...
import { useYtUrl } from './context/YtUrlContext';
...
export default function YtAnalysis({ result }: NewsAnalysisProps) {
        ...
        <div className="space-y-6">
            <div className="bg-white p-6 rounded-lg shadow-sm">
                <div className="flex items-center space-x-2 mb-4">
                    ...
                    <h2 className="text-xl font-semibold text-gray-900">Video Information</h2>
                </div>
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        <div>
                            ...
                            >
                                ...
                                <span>{ytUrl ? "View on YouTube" : "No YouTube URL available"}</span>
                            </a>
                        </div>
                </div>
            </div>
